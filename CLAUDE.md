...
1. Take question from database
2. Evaluated model is asked to write an open ended response to the question
3. Evaluator model is asked to score the answer across traits with numbers from 0 - 1
4. Repeat until all questions are answered
5. Application deterministically makes a summary of the traits and groups into a personality type
